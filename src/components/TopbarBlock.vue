...
<!--              &lt;!&ndash;begin::Svg Icon | path: icons/duotone/General/Search.svg&ndash;&gt;-->
...
<!--																&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Navigation/Close.svg&ndash;&gt;-->
...
<!--                    &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Code/Settings4.svg&ndash;&gt;-->
<!--                    <span class="svg-icon svg-icon-1">-->
...
<!--                    &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Navigation/Angle-down.svg&ndash;&gt;-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Communication/Clipboard-list.svg&ndash;&gt;-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Media/Equalizer.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/General/User.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg"-->
<!--                                             xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"-->
<!--                                             viewBox="0 0 24 24" version="1.1">-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Monitor.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Scatter-Up.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"-->
<!--                                             viewBox="0 0 24 24" fill="none">-->
<!--																					<g opacity="0.25">-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Doughnut.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"-->
<!--                                             viewBox="0 0 24 24" fill="none">-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Stacked-Area-Down.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"-->
<!--                                             viewBox="0 0 24 24" fill="none">-->
<!--																					<path opacity="0.25"-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Envelope.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"-->
<!--                                             viewBox="0 0 24 24" fill="none">-->
<!--																					<path opacity="0.25"-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Bank.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"-->
<!--                                             viewBox="0 0 24 24" fill="none">-->
<!--																					<path opacity="0.25"-->
...
<!--                    <div class="symbol symbol-40px me-4">-->
<!--																		<span class="symbol-label bg-light">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/Line-03-Up.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"-->
<!--                                             viewBox="0 0 24 24" fill="none">-->
<!--																					<path opacity="0.25"-->
...
<!--                  &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Interface/File-Search.svg&ndash;&gt;-->
...
<!--        <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"-->
<!--             @click.stop="toggleMenu('activities')"-->
...
<!--        <div class="btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px"-->
<!--             @click.stop="toggleMenu('links')"-->
<!--             data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end"-->
<!--             data-kt-menu-flip="bottom">-->
<!--          &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Layout/Layout-4-blocks.svg&ndash;&gt;-->
<!--          <span class="svg-icon svg-icon-1">-->
<!--													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"-->
<!--                               width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
...
<!--             v-bind:class="{'show': data.menu['links']}"-->
<!--             data-kt-menu="true">-->
<!--          &lt;!&ndash;begin::Heading&ndash;&gt;-->
...
<!--                &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Shopping/Euro.svg&ndash;&gt;-->
...
<!--                &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Communication/Mail-attachment.svg&ndash;&gt;-->
<!--                <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">-->
...
<!--                &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Shopping/Box2.svg&ndash;&gt;-->
<!--                <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">-->
<!--																<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"-->
<!--                                     width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
...
<!--                &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Communication/Group.svg&ndash;&gt;-->
<!--                <span class="svg-icon svg-icon-3x svg-icon-primary mb-2">-->
<!--																<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"-->
<!--                                     version="1.1">-->
<!--																	<path-->
...
<!--              &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Navigation/Right-2.svg&ndash;&gt;-->
...
<!--             data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end"-->
<!--             data-kt-menu-flip="bottom">-->
<!--          &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Code/Compiling.svg&ndash;&gt;-->
<!--          <span class="svg-icon svg-icon-1">-->
<!--													<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24"-->
<!--                               version="1.1">-->
<!--														<path-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Clothes/Crown.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"-->
<!--                                             viewBox="0 0 24 24" version="1.1">-->
<!--																					<path-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Code/Warning-2.svg&ndash;&gt;-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/General/Thunder.svg&ndash;&gt;-->
...
<!--                    <div class="symbol symbol-35px me-4">-->
<!--																		<span class="symbol-label bg-light-primary">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Communication/Flag.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-primary">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"-->
<!--                                             viewBox="0 0 24 24" version="1.1">-->
<!--																					<path-->
...
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Design/Image.svg&ndash;&gt;-->
...
<!--                    <div class="symbol symbol-35px me-4">-->
<!--																		<span class="symbol-label bg-light-warning">-->
<!--																			&lt;!&ndash;begin::Svg Icon | path: icons/duotone/Design/Component.svg&ndash;&gt;-->
<!--																			<span class="svg-icon svg-icon-2 svg-icon-warning">-->
<!--																				<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"-->
<!--                                             viewBox="0 0 24 24" version="1.1">-->
<!--																					<path-->
...
<!--      <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle" style="position: relative">-->
<!--        &lt;!&ndash;begin::Menu wrapper&ndash;&gt;-->
...
<!--          v-bind:class="{'show': data.menu['user']}"-->
<!--          @click.stop=""-->
<!--          data-kt-menu="true">-->
...
<!--            <a href="javascript:;" class="menu-link px-5" @click="logout">Выйти</a>-->
<!--          </div>-->
<!--          &lt;!&ndash;end::Menu item&ndash;&gt;-->
...
<!--          &lt;!&ndash;begin::Svg Icon | path: icons/duotone/Text/Toggle-Right.svg&ndash;&gt;-->
<!--          <span class="svg-icon svg-icon-1">-->
<!--													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"-->
<!--                               width="24px" height="24px" viewBox="0 0 24 24" version="1.1">-->
<!--														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">-->
