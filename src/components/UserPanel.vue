<template>
  <div id="kt_quick_user" class="offcanvas offcanvas-right p-10" v-bind:class="{'offcanvas-on': show}">
    <!--begin::Header-->
    <div class="offcanvas-header d-flex align-items-center justify-content-between pb-5" kt-hidden-height="40" style="">
      ...
      <a href="#" class="btn btn-xs btn-icon btn-light btn-hover-primary" id="kt_quick_user_close" @click="closeUserPanel()">
        <i class="ki ki-close icon-xs text-muted"></i>
      </a>
    </div>
    <!--end::Header-->
    <!--begin::Content-->
    <div class="offcanvas-content pr-5 mr-n5 scroll ps" style="height: 994px; overflow: hidden;">
      <!--begin::Header-->
      <div class="d-flex align-items-center mt-5">
        ...
        <div class="d-flex flex-column">
          ...
          <div class="navi mt-2">
            ...
            <a href="javascript:;" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" @click="logout()">Выйти</a>
          </div>
        </div>
      </div>
      <!--end::Header-->
  ...
  <div class="offcanvas-overlay" v-if="show" @click="closeUserPanel()"></div>
</template>
...
const show = computed(() => store.getters['general/GET_USER_PANEL'])

const closeUserPanel = () => {
  store.commit('general/CHANGE_USER_PANEL')
}
