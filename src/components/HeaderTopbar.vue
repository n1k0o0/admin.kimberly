<template>
  ...
  <div class="topbar">
    ...
    <!--begin::User-->
    <div class="topbar-item">
      <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle" @click="showUserPanel()">
        <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Привет,</span>
        <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{store.getters['auth/USER_NAME']}}</span>
        <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
              <span class="symbol-label font-size-h5 font-weight-bold">{{getFirstLetter()}}</span>
            </span>
      </div>
    </div>
    <!--end::User-->
...
const getFirstLetter = () => {
  let str = store.getters['auth/USER_NAME'];
  return str[0]
}
