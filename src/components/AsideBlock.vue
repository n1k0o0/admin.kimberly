    ...
    >
      <a href="javascript:;">
        <img
          alt="Logo"
          src="../assets/logo.svg"
          class="h-15px logo w-50px h-50px"
        >
      </a>
    </div>
        ...
        >
          ...
          <div class="menu-item">
            ...
            >
              ...
              <span class="menu-title">Внешние пользователи</span>
            </router-link>
          </div>
          <div class="menu-item">
            <router-link
          ...
          <div class="menu-item">
            ...
            >
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                  <i class="fas fa-white fa-graduation-cap" />
                </span>
              </span>
