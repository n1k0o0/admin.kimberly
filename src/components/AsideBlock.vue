<template>
  <div id="kt_aside" class="aside aside-hoverable" data-kt-drawer="true" data-kt-drawer-name="aside" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="{default:'200px', '300px': '250px'}" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_aside_mobile_toggle">
    <div class="aside-logo flex-column-auto" id="kt_aside_logo">
      <a href="javascript:;">
        <img alt="Logo" src="../assets/logo.svg" class="h-15px logo w-50px h-50px" />
      </a>
        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
          <div class="menu-item">
            <div class="menu-content pb-2">
              <span class="menu-section text-muted text-uppercase fs-8 ls-1 company-title">Kimberly</span>
            </div>
          </div>
          <div class="menu-item">
          ...
          <div class="menu-item">
            <router-link class="menu-link" to="/tables">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                </span>
              </span>
          ...
          <div class="menu-item">
            <router-link class="menu-link" to="/results">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                </span>
              </span>
          ...
          <div class="menu-item">
            <router-link class="menu-link" to="/players">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                </span>
              </span>
          ...
          <div class="menu-item">
            <router-link class="menu-link" to="/statistics">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                </span>
              </span>
          ...
          <div class="menu-item">
            <router-link class="menu-link" to="/notifications">
              <span class="menu-icon">
                <span class="svg-icon svg-icon-2">
                </span>
              </span>
